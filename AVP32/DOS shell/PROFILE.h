...
typedef struct _profile_data
 {
  ...
  char Memory,Sectors,Files,Packed,Archives,MailBases,MailPlain;
  char FileMask,UserMask[82],ExcludeFiles,ExcludeMask[82],*ExcludeDir,ScanRemovable;
  char ScanAllSectors;
  char InfectedAction,InfectedCopy,SuspiciousCopy;
