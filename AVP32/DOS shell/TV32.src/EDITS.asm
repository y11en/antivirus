...
;/*------------------------------------------------------------*/
        ...
        PUBLIC @TEditor@formatLine$qnvuiius
...
;char TEditor::bufChar( size_t P )
PROC    @TEditor@bufChar$qui
...
;                          ushort Colors
;                        )
PROC    @TEditor@formatLine$qnvuiius
