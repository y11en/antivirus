/*
        NO_TV_STREAMS version (FILE *) is not tested!
*/
...
char *THelpTopic::getLine( int line )
{
    int offset, i;
    TParagraph *p;
    static char buffer[256];    // bug fix (added static) ig 14.04.95
...
{
    static char line[256];      // bug fix (added static) ig 14.04.95
    int i;
