// fpiapi.h
//
// Copyright (c) 1998-2002 F-Secure Corp.
//
...
#ifdef UNIX
DllExport void FPIFN FPI_SetProgramDirectory(const char* path_);
typedef void (FPIFN *LPFPI_SetProgramDirectory) (const char * /*path_*/);
#endif /* UNIX */
