...
{$IFDEF FR_COM}
  TfsScript = class(TComponent, IfsScript)
{$ELSE}
...
{$IFDEF FR_COM}
  protected
    function Get_Lines(out Value: WideString): HResult; stdcall;
    function Set_Lines(const Value: WideString): HResult; stdcall;
    function Get_Line(Index: Integer; out Value: WideString): HResult; stdcall;
    function Set_Line(Index: Integer; const Value: WideString): HResult; stdcall;
    function Get_ErrorMessage(out Value: WideString): HResult; stdcall;
    function Get_ErrorPosition(out Value: WideString): HResult; stdcall;
    function Get_ErrorUnit(out Value: WideString): HResult; stdcall;
    function Get_ExtendedCharset(out Value: WordBool): HResult; stdcall;
    function Set_ExtendedCharset(Value: WordBool): HResult; stdcall;
    function Set_ScriptLanguage(Value: fs_ScriptType): HResult; stdcall;
    function Get_Variables(const Name: WideString; out Value: OleVariant): HResult; stdcall;
    function Set_Variables(const Name: WideString; Value: OleVariant): HResult; stdcall;
    function Get_MainProg(out Value: WordBool): HResult; stdcall;
    function Get_Parent(out Value: IfsScript): HResult; stdcall;
    function Get_ProgramRunning(out Value: IfsScript): HResult; stdcall;
    function Get_CallFunction(const Name: WideString; Params: OleVariant; out Value: OleVariant): HResult; stdcall;
    function Get_Evaluate(const Expression: WideString; out Value: OleVariant): HResult; stdcall;
    function RunScript: HResult; stdcall;
    function CompileScript: HResult; stdcall;
    function ExecuteScript: HResult; stdcall;
    function TerminateScript: HResult; stdcall;
{$ENDIF}
  public
...
{$IFDEF DEBUG}
    procedure SetParentValue(val: Variant);
    property ParentValue: Variant read FParentValue write SetParentValue;
{$ELSE}
...
{$IFDEF DEBUG}
procedure TfsCustomHelper.SetParentValue(val: Variant);
begin
  FParentValue := val;
  if (val = 0) and (Self is TfsPropertyHelper) then
    Writeln('Value set to Null for TfsPropertyHelper');
end;
{$ENDIF}
...
{$IFDEF DEBUG}
    ...
    Writeln('Got exception in TfsPropertyHelper.GetValue');
  end;
{$ENDIF}
end;
...
{$IFDEF DEBUG}
    ...
    Writeln('Got exception in TfsPropertyHelper.SetValue');
  end;
{$ENDIF}
end;
...
{$IFDEF DEBUG}
  if ParentValue = 0 then
    WriteLn('No parent in TfsEventHelper.SetValue(');
{$ENDIF}
...
{$IFDEF FR_COM}
function TfsScript.Get_Lines(out Value: WideString): HResult; stdcall;
begin
  Value := Lines.GetText;
  Result := S_OK;
end;

function TfsScript.Set_Lines(const Value: WideString): HResult; stdcall;
begin
  Lines.SetText(PAnsiChar(String(Value)));
  Result := S_OK;
end;

function TfsScript.Get_Line(Index: Integer; out Value: WideString): HResult; stdcall;
begin
  Value := Lines[Index];
  Result := S_OK;
end;

function TfsScript.Set_Line(Index: Integer; const Value: WideString): HResult; stdcall;
begin
  Lines[Index] := Value;
  Result := S_OK;
end;

function TfsScript.Get_ErrorMessage(out Value: WideString): HResult; stdcall;
begin
  Value :=  ErrorMsg;
  Result := S_OK;
end;

function TfsScript.Get_ErrorPosition(out Value: WideString): HResult; stdcall;
begin
  Value :=  ErrorPos;
  Result := S_OK;
end;

function TfsScript.Get_ErrorUnit(out Value: WideString): HResult; stdcall;
begin
  Value :=  ErrorUnit;
  Result := S_OK;
end;

function TfsScript.Get_ExtendedCharset(out Value: WordBool): HResult; stdcall;
begin
  Value := ExtendedCharset;
  Result := S_OK;
end;

function TfsScript.Set_ExtendedCharset(Value: WordBool): HResult; stdcall;
begin
  ExtendedCharset := Value;
  Result := S_OK;
end;

function TfsScript.Set_ScriptLanguage(Value: fs_ScriptType): HResult; stdcall;
begin
  Result := S_OK;
  case Value of
  PascalScript: SyntaxType := 'PascalScript';
  CScript:      SyntaxType := 'C++Script';
  BasicScript:  SyntaxType := 'BasicScript';
  JScript:      SyntaxType := 'JScript'
  else
    Result := E_INVALIDARG;
  end;
end;

function TfsScript.Get_Variables(const Name: WideString; out Value: OleVariant): HResult; stdcall;
begin
  Value := Variables[Name];
  Result := S_OK;
end;

function TfsScript.Set_Variables(const Name: WideString; Value: OleVariant): HResult; stdcall;
begin
  Variables[Name] := Value;
  Result := S_OK;
end;

function TfsScript.Get_MainProg(out Value: WordBool): HResult; stdcall;
begin
  Value := MainProg;
  Result := S_OK;
end;

function TfsScript.Get_Parent(out Value: IfsScript): HResult; stdcall;
begin
  Value := Parent;
  Result := S_OK;
end;

function TfsScript.Get_ProgramRunning(out Value: IfsScript): HResult; stdcall;
begin
  Value := ProgRunning;
  Result := S_OK;
end;

function TfsScript.Get_CallFunction(const Name: WideString; Params: OleVariant; out Value: OleVariant): HResult; stdcall;
begin
  Value := CallFunction( Name, Params );
  Result := S_OK;
end;

function TfsScript.Get_Evaluate(const Expression: WideString; out Value: OleVariant): HResult; stdcall;
begin
  try
    Value := Evaluate( Expression );
  except
    Value := 'Error in expression';
  end;
  Result := S_OK;
end;

function TfsScript.RunScript: HResult; stdcall;
begin
  Run;
  Result := S_OK;
end;

function TfsScript.CompileScript: HResult; stdcall;
begin
  Compile;
  Result := S_OK;
end;

function TfsScript.ExecuteScript: HResult; stdcall;
begin
  Execute;
  Result := S_OK;
end;

function TfsScript.TerminateScript: HResult; stdcall;
begin
  Terminate;
  Result := S_OK;
end;
