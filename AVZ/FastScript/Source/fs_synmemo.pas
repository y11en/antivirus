...
type
  ...
  TCharAttr = (caNo, caText, caBlock, caComment, caKeyword, caString, caUserKeyword);
  TCharAttributes = set of TCharAttr;
  // Обработчик события "требуется проверка, является ли слово UserKeyword"
  TCheckUserKeyword = function (AKeyword : string):boolean of object;
  ...
  private
    ...
    FOnCheckUserKeyword: TCheckUserKeyword;
    ...
    procedure SetUserKeywordAttr(const Value: TFont);
    procedure SetOnCheckUserKeyword(const Value: TCheckUserKeyword);
...
{$ENDIF}
  ...
  published
    ...
    property UserKeywordAttr: TFont read FUserKeywordAttr write SetUserKeywordAttr;
    ...
    property OnCheckUserKeyword : TCheckUserKeyword read FOnCheckUserKeyword write SetOnCheckUserKeyword;
    property OnClick;
    property OnDblClick;
    property OnDragDrop;
    property OnDragOver;
...
begin
  ...
  FUserKeywordAttr := TFont.Create;
  FUserKeywordAttr.Color := clGreen;
...
begin
  ...
  FUserKeywordAttr.Size := Font.Size;
  FUserKeywordAttr.Name := Font.Name;
...
var
  ...
  begin
    ...
    begin
      ...
      if caUserKeyword in a then
        Font.Assign(FUserKeywordAttr);
...
var
  ...
  function IsUserKeyWord(const s: String): Boolean;
  begin
    Result := False;
    if Assigned(FOnCheckUserKeyword) then
     Result := FOnCheckUserKeyword(S);
  end;
  ...
  begin
    ...
    begin
      ...
      if IsKeyWord(Copy(FSyn, i, Pos - i)) then
        Result := caKeyword;
      if IsUserKeyWord(Copy(FSyn, i, Pos - i)) then
        Result := caUserKeyword;
      Dec(Pos);
    end
...
procedure TfsSyntaxMemo.SetUserKeywordAttr(const Value: TFont);
begin
  FUserKeywordAttr := Value;
end;

procedure TfsSyntaxMemo.SetOnCheckUserKeyword(
  const Value: TCheckUserKeyword);
begin
  FOnCheckUserKeyword := Value;
end;
