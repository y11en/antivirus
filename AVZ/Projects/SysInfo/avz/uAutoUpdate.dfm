object AutoUpdate: TAutoUpdate
  ...
  object pbCurrentOp: TProgressBar
    Left = 2
    Top = 177
    Width = 531
    Height = 17
  ...
  object pbFullProgress: TProgressBar
    Left = 2
    Top = 201
    Width = 531
    Height = 17
  ...
  object ceSetup: TComboEdit
    ...
    TabOrder = 4
    Text = 'ceSetup'
    OnButtonClick = ceSetupButtonClick
  end
