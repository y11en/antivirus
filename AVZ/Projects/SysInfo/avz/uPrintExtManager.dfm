object PrintExtManager: TPrintExtManager
  Left = 234
  Top = 129
  Width = 696
  Height = 455
  ...
  object dgPrintExt: TRxDrawGrid
    ...
    TabOrder = 1
    OnClick = dgPrintExtClick
    OnDrawCell = dgPrintExtDrawCell
    OnMouseDown = dgPrintExtMouseDown
    FixedButtons = True
    ColWidths = (
      293
      116
