object ProtocolManager: TProtocolManager
  Left = 215
  Top = 144
  Width = 694
  Height = 480
  ...
  object dgProtocol: TRxDrawGrid
    ...
    Align = alClient
    FixedCols = 0
    PopupMenu = pmProtocolPopUp
    TabOrder = 1
    OnClick = dgProtocolClick
    OnDrawCell = dgProtocolDrawCell
    FixedButtons = True
    ColWidths = (
      461
      177
  ...
  object pmProtocolPopUp: TPopupMenu
    Left = 128
    Top = 184
    object N3: TMenuItem
      Caption = '$AVZ0360'
