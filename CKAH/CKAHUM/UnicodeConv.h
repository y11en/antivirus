...
#define __LPSTR(str)	(str_base_conversion_to_char(str).get_buffer())
#define __LPCSTR(str)	__LPSTR(str)

#ifdef _UNICODE
	#define StringStackBufferT	StringStackBufferW
	#define InitAndConvert_A2T(stack_buff, str)	InitAndConvert_A2W(stack_buff, str)
	#define InitAndConvert_W2T(stack_buff, str)	(str)
	#define __LPTSTR(str)	(str_base_conversion_to_wchar(str).get_buffer())
	#define __LPCTSTR(str)	__LPTSTR(str)
#else
	#define StringStackBufferT	StringStackBufferA
	#define InitAndConvert_A2T(stack_buff, str)	(str)
	#define InitAndConvert_W2T(stack_buff, str)	InitAndConvert_W2A(stack_buff, str)
	#define __LPTSTR(str)	(str_base_conversion_to_char(str).get_buffer())
	#define __LPCTSTR(str)	__LPTSTR(str)
#endif

#define __LPWSTR(str)	(str_base_conversion_to_wchar(str).get_buffer())
