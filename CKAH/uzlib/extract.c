    ...
    /*-----------------------------------------------------------------------
      ...
      -----------------------------------------------------------------------*/
        ...
        G.cur_zipfile_bufstart =
          _lseek(G.zipfd, (LONGINT)cd_bufstart, SEEK_SET);
#endif /* ?USE_STRM_INPUT */
        _read(G.zipfd, (char *)G.inbuf, INBUFSIZ);  /* been here before... */
        G.inptr = cd_inptr;
        G.incnt = cd_incnt;
        ++blknum;
...
#else /* !USE_STRM_INPUT */
            G.cur_zipfile_bufstart =
              _lseek(G.zipfd, (LONGINT)bufstart, SEEK_SET);
#endif /* ?USE_STRM_INPUT */
  ...
  ---------------------------------------------------------------------------*/
    ...
    if (uO.tflag) {
...
#endif
        {
            ...
            _setmode(_fileno(G.outfile), O_BINARY);
