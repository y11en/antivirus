...
#  define UZ_VERSION_DATE   "16 Apr 04"         /* internal beta version */
#else
#  define UZ_BETALEVEL      ""
#  define UZ_VERSION_DATE   "22 May 2004"       /* official release version */
#  define RELEASE
#endif
...
#define UZ_VER_STRING  "5.51"         /* keep in sync with Version numbers! */
