...
{
  typedef _DBG_hashtable<_Val, _Key, _HF, _Traits, _ExK, _EqK, _All> _Self;
...
#define _STLP_TEMPLATE_CONTAINER _DBG_hashtable<_Val,_Key,_HF,_Traits,_ExK,_EqK,_All>
#define _STLP_TEMPLATE_CONTAINER_BASE hashtable<_Val,_Key,_HF,_Traits,_ExK,_EqK,_All>
...
struct __move_traits<_DBG_hashtable<_Val,_Key,_HF,_Traits, _ExK,_EqK,_All> > :
