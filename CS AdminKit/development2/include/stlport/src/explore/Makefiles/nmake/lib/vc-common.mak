...
OPT_DBG = $(OPT_DBG) /MTd /D_STLP_NEW_PLATFORM_SDK
OPT_STLDBG = $(OPT_STLDBG) /MTd /D_STLP_NEW_PLATFORM_SDK
OPT_REL = $(OPT_REL) /MT /D_STLP_NEW_PLATFORM_SDK
!else
OPT_DBG = $(OPT_DBG) /MDd /D_STLP_NEW_PLATFORM_SDK
OPT_STLDBG = $(OPT_STLDBG) /MDd /D_STLP_NEW_PLATFORM_SDK
OPT_REL = $(OPT_REL) /MD /D_STLP_NEW_PLATFORM_SDK
!endif

!ifdef STLP_BUILD_FORCE_DYNAMIC_RUNTIME
OPT_STATIC_DBG = $(OPT_STATIC_DBG) /MDd /D_STLP_NEW_PLATFORM_SDK
OPT_STATIC_STLDBG = $(OPT_STATIC_STLDBG) /MDd /D_STLP_NEW_PLATFORM_SDK
OPT_STATIC_REL = $(OPT_STATIC_REL) /MD /D_STLP_NEW_PLATFORM_SDK
!else
OPT_STATIC_DBG = $(OPT_STATIC_DBG) /MTd /D_STLP_NEW_PLATFORM_SDK
OPT_STATIC_STLDBG = $(OPT_STATIC_STLDBG) /MTd /D_STLP_NEW_PLATFORM_SDK
OPT_STATIC_REL = $(OPT_STATIC_REL) /MT /D_STLP_NEW_PLATFORM_SDK
!endif
