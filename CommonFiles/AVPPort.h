...
#include "AVPSize_t.h"
	...
	#define _WCHAR_T_DEFINED
			...
			#include <wchar.h>
		#endif
	#elif defined (__unix__) && defined( __cplusplus) && defined (HAS_BUILTIN_WCHAR_T)
...
// now defined in AVPSize_t.h
//#if !defined (_SIZE_T_DEFINED_) && !defined (__unix__)
//	#define _SIZE_T_DEFINED_
//		
//	#if !defined(_SIZE_T) && !defined(_WIN64)
//		#define _SIZE_T
...
#if !((defined(__WATCOMC__) && (defined(__DOS__)||defined(__OS2__))) || (defined (__unix__))) && !defined(__MWERKS__) && !defined(__APPLE__)
...
#else /* !((defined(__WATCOMC__) && (defined(__DOS__)||defined(__OS2__))) || (defined (__unix__))) && !defined(__MWERKS__) && !defined(__APPLE__) */
