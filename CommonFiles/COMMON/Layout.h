...
******************************************************************************/
#ifndef __COMMON_LAYOUT_H
#define __COMMON_LAYOUT_H
...
#define lPIXEL(pxl_offset)			0x7FFFFFFF, 0,            pxl_offset
...
COMMONEXPORT BOOL Layout_ComputeLayout (HWND hwndDlg, RULE* pRules);

///////////////////////////////// End of File /////////////////////////////////

#endif // __COMMON_LAYOUT_H
