...
BOOL LoadKeyTree( const TCHAR* pKeyFileName, HDATA *hRootData, BOOL &bVerified );
BOOL LoadKeyTreeEx( const TCHAR* pKeyFileName, HDATA *hRootData, BOOL &bVerified, void* (*pfMemAlloc)(AVP_uint), void (*pfMemFree)(void*) );
