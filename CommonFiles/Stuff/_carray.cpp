...
//
//  _CARRAY.CPP
//  CPtrArray implementation (without MFC)
//  General purpose
...
#if defined (NOAFX) || defined (__unix__)
...
void CPtrArray::Reserve(int nNewSize)
{
...
void CPtrArray::ReserveAdditional(int nAdditionalSize)
{
	int nOldSize = m_nSize;
	SetSize(nOldSize + nAdditionalSize);
	m_nSize = nOldSize;
}
