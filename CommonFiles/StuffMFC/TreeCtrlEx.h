...
// Construction
public:
	CTreeCtrlEx() : m_bSelectPending(FALSE), m_hClickedItem(NULL), m_hFirstSelectedItem(NULL), m_bSelectionComplete(TRUE) {}
...
public:
	...
	{
		return !!(TVIS_SELECTED & GetItemState(hItem, TVIS_SELECTED));
	};
