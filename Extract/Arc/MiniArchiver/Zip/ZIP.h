...
#define ppZIP_DATA         mPROPERTY_MAKE_PRIVATE(pTYPE_BINARY , 0x00002002)
#define ppZIP_POSITION     mPROPERTY_MAKE_PRIVATE(pTYPE_DWORD  , 0x00002008)
#define ppZIP_NAME         mPROPERTY_MAKE_PRIVATE(pTYPE_BINARY , 0x00002005)
#define ppCOMPRESSED_IO    mPROPERTY_MAKE_PRIVATE(pTYPE_OBJECT , 0x00002006)
#define ppOUTPUT_IO        mPROPERTY_MAKE_PRIVATE(pTYPE_OBJECT , 0x00002007)
#define ppZIP_POSITION_OF_HEADER mPROPERTY_MAKE_PRIVATE(pTYPE_DWORD , 0x00002003)
#define ppZIP_SIZE_OF_RAW_DATA mPROPERTY_MAKE_PRIVATE(pTYPE_DWORD , 0x00002004)

//#define ppIS_PASSWORD_PROTECTED mPROPERTY_MAKE_PRIVATE(pTYPE_BOOL , 0x00000008)
#define ppZIP_IO mPROPERTY_MAKE_PRIVATE(pTYPE_OBJECT , 0x00002000)
