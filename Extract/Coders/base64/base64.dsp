...
# PROP Scc_ProjName ""$/Prague/base64", MHOFBAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD LINK32 libcmt.lib /nologo /base:"0x62400000" /entry:"DllMain" /subsystem:windows /dll /debug /machine:I386 /nodefaultlib /out:"..\..\out\Release\base64.ppl" /opt:ref
...
# ADD LINK32 /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\..\out\Debug\base64.ppl" /implib:"" /pdbtype:sept
...
SOURCE=..\Include\plugin\p_base64.h
# End Source File
# End Group
