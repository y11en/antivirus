...
#if !defined(__KL_IMAPPROTOCOLANALYZERIMPL_H)
#define __KL_IMAPPROTOCOLANALYZERIMPL_H
...
//////////////////////////////////////////////////////////////////////////
class ImapProtocolAnalyzerImpl : public BaseProtocolAnalyzerImpl
{
	typedef BaseProtocolAnalyzerImpl Base;
public:
	ImapProtocolAnalyzerImpl()  
		: Base()
...
private:
	...
	const char* RecognizeFetchResponse(const char* data_begin, const char* data_end);
private:
	// enums & types
	enum detect_state
	{
...
#endif   // !defined(__KL_IMAPPROTOCOLANALYZERIMPL_H)
