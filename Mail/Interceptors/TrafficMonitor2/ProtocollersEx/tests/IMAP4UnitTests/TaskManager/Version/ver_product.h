...
#define VER_PRODUCTVERSION_HIGH             7
#define VER_PRODUCTVERSION_LOW              0
#define VER_PRODUCTVERSION_BUILD            1
#define VER_PRODUCTVERSION_COMPILATION      222
...
#define VER_PRODUCT_REGISTRY_NAME_W			L"AVP7"
#define VER_PRODUCT_REGISTRY_PATH_W			VER_PRODUCT_REGISTRY_ROOT_W L"\\" VER_PRODUCT_REGISTRY_NAME_W

#define VER_PRODUCT_APPDATA_NAME_W          L"AVP7"

#define VER_PRODUCT_REGISTRY_PROT_W			L"KASPERSKYLAB\\PROTECTED"
// -------------------------------------------------------------------------------------------------

#define VER_PRODUCT_REGISTRY_AK_FS			"KAVFS7\\7.0.0.0"
#define VER_PRODUCT_REGISTRY_AK_WKS			"KAVWKS7\\7.0.0.0"
#define VER_PRODUCT_REGISTRY_AK_SOS			"KAVSOS7\\7.0.0.0"
