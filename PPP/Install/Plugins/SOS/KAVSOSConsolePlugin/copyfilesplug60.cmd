...
rem ################
%XCOPY_CMD% /S "%SOURCE_DIR%\%OUT_FOLDER%\Release\ap_sos.reg" "%TARGET_DIR%\Registry\"
if ERRORLEVEL 1 goto err

rem ################
%XCOPY_CMD% "%SOURCE_DIR%\%OUT_FOLDER%\Release\ap_sos.dll" "%TARGET_DIR%\"
if ERRORLEVEL 1 goto err

%XCOPY_CMD% "%SOURCE_DIR%\%OUT_FOLDER%\Release\ap_sosi.dll" "%TARGET_DIR%\"
if ERRORLEVEL 1 goto err
