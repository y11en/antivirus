...
rem ################
copy /Y "%SOURCE_DIR%\PPP\gui60\HelpPlugin\%loc_name%\WKS\context.chm" "%TARGET_DIR%\Doc\context_wks.chm"
if ERRORLEVEL 1 goto err

copy /Y "%SOURCE_DIR%\PPP\gui60\HelpPlugin\%loc_name%\FS\context.chm" "%TARGET_DIR%\Doc\context_fs.chm"
if ERRORLEVEL 1 goto err
