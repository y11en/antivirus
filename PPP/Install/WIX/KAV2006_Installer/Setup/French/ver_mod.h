...
#define VER_LEGALCOPYRIGHT_STR   "Copyright © Kaspersky Lab, 1996-2007. Tous droits réservés."
#define VER_LEGALTRADEMARKS_STR  "Kaspersky™ Anti-Virus ® est une marque déposée de Kaspersky Lab."
