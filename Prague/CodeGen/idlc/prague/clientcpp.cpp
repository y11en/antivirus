...
int main() {
	...
	err = CALL_SYS_ObjectCreateQuick(g_root, (hOBJECT*)&sample, Base::IID, PLUGINID_SamplePlugin, SampleImpl::IID);
	...
	err = CALL_SYS_PropertySet(sample, NULL, SampleI::IProp, "My Value", sizeof("My Value"));
	...
	err = CALL_SYS_PropertyGet(sample, NULL, SampleI::IProp, buffer, sizeof(buffer));
	...
	tDATA value = 1234;
	err = CALL_SYS_PropertySet(sample, NULL, Base::BaseProp, &value, sizeof(value));
	...
	value = 0;	
	err = CALL_SYS_PropertyGet(sample, NULL, Base::BaseProp, &value, sizeof(value));
