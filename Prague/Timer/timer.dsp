...
# PROP Scc_ProjName ""$/Prague/Timer", FLMIAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# PROP Intermediate_Dir "../../temp/Release/prague/timer"
...
# ADD LINK32 kernel32.lib /nologo /base:"0x68100000" /entry:"DllMain" /subsystem:windows /dll /pdb:"..\..\out/Release/timer.pdb" /debug /machine:I386 /out:"..\..\out/Release/timer.ppl" /opt:ref
...
# PROP Intermediate_Dir "../../temp/Debug/prague/timer"
# PROP Ignore_Export_Lib 1
# PROP Target_Dir ""
LIB32=link.exe -lib
...
# ADD LINK32 /nologo /subsystem:windows /dll /pdb:"..\..\out/Debug/timer.pdb" /debug /machine:I386 /out:"..\..\out/Debug/timer.ppl" /implib:"" /pdbtype:sept
...
SOURCE=..\Include\iface\i_timer.h
# End Source File
# Begin Source File

SOURCE=..\Include\plugin\p_timer.h
# End Source File
# Begin Source File
