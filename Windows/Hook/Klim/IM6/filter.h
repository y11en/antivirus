...
#define FILTER_ALLOC_TAG                         'milK'
#define FILTER_TAG                               'milK'
...
#define FILTER_FRIENDLY_NAME        L"Kaspersky Lab NDIS 6 Filter"
#define FILTER_UNIQUE_NAME          L"{C477F579-9F31-474D-86CC-E1567F0BFD1D}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"KLIM6"
//
// The filter needs to handle IOCTRLs
//
#define LINKNAME_STRING             L"\\DosDevices\\KLIM6"
#define NTDEVICE_STRING             L"\\Device\\KLIM6"
...
#define NET_BUFFER_LIST_LINK_TO_ENTRY(_pNBL)    ((PQUEUE_ENTRY)((_pNBL)->Next))
...
typedef struct _MS_FILTER
{
    ...
    NPAGED_LOOKASIDE_LIST			InPktList;
    NPAGED_LOOKASIDE_LIST			OutPktList;

    ULONG                           MaxFrameSize;
    ULONG                           MaxSpeed;
    ULONG                           CurrentIP;
    char                            CurrentMacAddr[6];
     
    NDIS_PORT_ARRAY                 PortArray;
    ULONG                           Reserved[100];
