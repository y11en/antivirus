# Microsoft Developer Studio Project File - Name="klpid9x" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=klpid9x - Win32 Release
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "klpid9x.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "klpid9x.mak" CFG="klpid9x - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "klpid9x - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "klpid9x - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD LINK32 icrtms.obj clms4.lib daams.lib ndms95.lib rtms.lib ntms.lib wr0ms.lib wr1ms.lib wr2ms.lib wr3ms.lib cfms.lib true.lib /nologo /pdb:none /debug /debugtype:both /machine:IX86 /out:"Release\klpid.vxd" /libpath:"$(VTOOLSD)\lib" /libpath:"..\..\..\..\Personal Firewall\Drivers" /IGNORE:4078,4039,4070 /VXD /MERGE:.data=_LDATA /MERGE:ICRTTEXT=_IDATA /MERGE:ICRTXXXX=_IDATA /MERGE:.rdata=_LDATA /MERGE:.bss=_LDATA /MERGE:_PDATA=_PTEXT /MERGE:.rsrc=_IDATA
# SUBTRACT LINK32 /nodefaultlib
# Begin Special Build Tool
TargetPath=.\Release\klpid.vxd
TargetName=klpid
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "klpid9x - Win32 Debug"
...
# ADD LINK32 icrtms.obj daams.lib clms4.lib ndms95d.lib rtmsd.lib ntms.lib wr0ms.lib wr1ms.lib wr2ms.lib wr3ms.lib cfmsd.lib true.lib /nologo /incremental:no /debug /machine:IX86 /out:"Debug\klpid.vxd" /libpath:"$(VTOOLSD)\lib" /libpath:"..\..\..\..\Personal Firewall\Drivers" /IGNORE:4078,4039,4070,4075 /VXD /MERGE:.data=_LDATA /MERGE:ICRTTEXT=_IDATA /MERGE:ICRTXXXX=_IDATA /MERGE:.rdata=_LDATA /MERGE:.bss=_LDATA /MERGE:_PDATA=_PTEXT /MERGE:.CRT=_LTEXT /MERGE:.rsrc=_IDATA
# SUBTRACT LINK32 /pdb:none /nodefaultlib
# Begin Special Build Tool
TargetPath=.\Debug\klpid.vxd
TargetName=klpid
SOURCE="$(InputPath)"
...
# Name "klpid9x - Win32 Release"
# Name "klpid9x - Win32 Debug"
