...
void
DisconnectClientByThreadID(HANDLE ThreadID);
...
//! \param          : tefVerdict* pVerdict - если объект найден в кеше то вердикт будет заполнен закешированными данными
DWORD
...
//! \param          : tefVerdict Verdict - ассоциированные данные
