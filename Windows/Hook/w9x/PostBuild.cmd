%VTOOLSD%\bin\sethdr -n KLIF -x %2 -r %3.res
...
xcopy ..\Release9x\KLIF.vxd %Rcopydest% /R /D /Y
goto _Exit

:_Debug
echo PostBuildStep ---- Debug detected
rem call nmsym /PROMPT /SOURCE:.;%VTOOLSD%src\ /TRANSLATE:SOURCE,PACKAGE,ALWAYS %2 
%VTOOLSD%\..\SOFTICE\nmsym.exe /PROMPT /SOURCE:.;..;%VTOOLSD%\src /TRANSLATE:SOURCE,PACKAGE,ALWAYS ..\Debug9x\KLIF.vxd
xcopy ..\Debug9x\KLIF.vxd %Dcopydest% /R /D /Y
xcopy ..\Debug9x\KLIF.nms %Dcopydest% /R /D /Y
