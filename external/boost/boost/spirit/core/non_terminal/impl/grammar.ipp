...
struct grammar_definition
{
    ...
    //////////////////////////////////
# ifdef BOOST_SPIRIT_THREADSAFE
   template<typename self, typename scanner_t, typename ptr_t>
   struct init_ptr
   {
...
# ifdef BOOST_SPIRIT_THREADSAFE
	typedef init_ptr<self_t, ScannerT, ptr_t> init_ptr_t;
	static boost::once_flag been_here = BOOST_ONCE_INIT;
        boost::call_once(init_ptr_t::do_init, been_here);
	ptr_t &helper = init_ptr_t::ptr_instance();
# else
        static ptr_t helper;
# endif
