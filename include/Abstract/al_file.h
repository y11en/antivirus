...
AL_DECLARE_INTERFACE_BEGIN
	...
	AL_DECLARE_METHOD3(bool, GetTime, uint64* pnCreateTime, uint64* pnLastWriteTime, uint64* pnLastAccessTime); // time as Windows FILETIME
	AL_DECLARE_METHOD3(bool, SetTime, uint64 nCreateTime, uint64 nLastWriteTime, uint64 nLastAccessTime); // time as Windows FILETIME, 0=don't change
